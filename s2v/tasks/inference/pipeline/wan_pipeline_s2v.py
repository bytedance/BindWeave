...
class WanS2VPipeline(WanPipeline):
    ...
    def merge_ref_vae_feature(self, i2v_vae_feature, ref_vae_feature_list, max_ref=4):
        ...
        pad = torch.zeros(bs, c, t+max_ref-n, h, w, device=i2v_vae_feature.device, dtype=i2v_vae_feature.dtype) # (1, 4+16, t+max_ref, h, w)
    ...
    def predict_raw_samples(self, sample_list, 
        ...
        image = Image.open(io.BytesIO(sample_list[0]['image']))
        ...
        ref_image_list = [Image.open(io.BytesIO(ref_image)) for ref_image in sample_list[0]['ref_image_list']]
